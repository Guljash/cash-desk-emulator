...
document.getElementById('left_main_button').onclick = function(){
	...
	if (dl === 0){
		dl = 1;
		document.getElementById('left_main_button').style = 'opacity:0.8;';
		...
		dl = 0
		document.getElementById('left_main_button').style = 'opacity:1;';
...
document.getElementById('right_main_button').onclick = function(){
	...
	if (dr === 0){
		dr = 1;
		document.getElementById('right_main_button').style = 'opacity:0.8;';
		...
		dr = 0
		document.getElementById('right_main_button').style = 'opacity:1;';
...
document.getElementById('l_bot_main_button').onclick = function(){
	...
	if (dl === 0){
		dl = 1;
		document.getElementById('l_bot_main_button').style = 'opacity:0.8;';
		...
		dl = 0
		document.getElementById('l_bot_main_button').style = 'opacity:1;';
...
document.getElementById('r_bot_main_button').onclick = function(){
	...
	if (dl === 0){
		dl = 1;
		document.getElementById('r_bot_main_button').style = 'opacity:0.8;';
		...
		dl = 0
		document.getElementById('r_bot_main_button').style = 'opacity:1;';
